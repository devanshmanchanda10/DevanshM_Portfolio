...
const Portfolio = () => {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-blue-100 selection:text-blue-900 relative overflow-hidden">
      ...
      {/* --- HERO SECTION --- */}
      <section id="home" className="pt-28 pb-12 md:pt-32 md:pb-16 px-6 relative z-10">
        <div className="container mx-auto max-w-5xl text-center">
          <div className="inline-flex items-center px-3 py-1 rounded-full bg-blue-50 border border-blue-100 text-blue-600 text-xs font-bold tracking-wide uppercase mb-6 animate-fade-in-up">
            <span className="w-2 h-2 rounded-full bg-blue-600 mr-2 animate-pulse"></span>
            Aspiring Product Manager
          </div>

          <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold text-slate-900 leading-[1.1] mb-6 tracking-tight animate-fade-in-up [animation-delay:100ms]">
          ...
          <p className="text-lg md:text-xl text-slate-600 leading-relaxed mb-8 max-w-2xl mx-auto font-light animate-fade-in-up [animation-delay:200ms]">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 animate-fade-in-up [animation-delay:300ms]">
            <button
              ...
              className="group flex items-center justify-center px-8 py-3 bg-slate-900 text-white rounded-2xl font-semibold hover:bg-blue-600 transition-all shadow-xl shadow-slate-900/20 hover:shadow-blue-600/30 hover:-translate-y-1"
            >
              See My Work
